...
public class FacturaPDF {
    ...
    public static final String RESULT = "C:/factura.pdf";
...
/*
        canvas.moveTo(margen+20, top-90-80-70-35-50);
        canvas.lineTo(right-20, top-90-80-70-35-50);
*/
        int angulo = 0;
        //PANER IZQUIERDO
        canvas.beginText();
        canvas.setFontAndSize(bf_helv, 13);
        ...
        canvas.showTextAligned(Element.ALIGN_CENTER, "FACTURA ELECTRONICA N° "+ pago.getSerie()+'-'+pago.getNumero(), margen+50+40, top-alturaHeader-90, angulo);
        
        canvas.setFontAndSize(bf_helv, 8);
        canvas.showTextAligned(Element.ALIGN_LEFT, "FECHA", margen+15, top-alturaHeader-110, angulo);
        canvas.showTextAligned(Element.ALIGN_LEFT, ":"+ "   "+"28/08/2018 14:10:00", margen+15+35, top-alturaHeader-110, angulo);

        canvas.showTextAligned(Element.ALIGN_LEFT, "CLIENTE", margen+15, top-alturaHeader-125, angulo);
        canvas.showTextAligned(Element.ALIGN_LEFT, ":"+ "   "+boleta.getCliente(), margen+15+35, top-alturaHeader-125, angulo);

        canvas.showTextAligned(Element.ALIGN_LEFT, "CAJA", margen+15, top-alturaHeader-140, angulo);
        ...
        canvas.showTextAligned(Element.ALIGN_RIGHT, "SUB TOTAL", margen+95, top-alturaHeader-170-alturaDetalle, angulo);
        canvas.showTextAligned(Element.ALIGN_RIGHT, pago.getMoneda()+" "+pago.getSubTotal(), margen+95+20+40, top-alturaHeader-170-alturaDetalle, angulo);        	
        
        alturaDetalle = alturaDetalle + 20;
        canvas.showTextAligned(Element.ALIGN_RIGHT, "IGV", margen+95, top-alturaHeader-170-alturaDetalle, angulo);
        canvas.showTextAligned(Element.ALIGN_RIGHT, pago.getMoneda()+" "+pago.getIgv(), margen+95+20+40, top-alturaHeader-170-alturaDetalle, angulo);        	
        ...
        canvas.moveTo(margen+20, top-alturaHeader-170-alturaDetalle-20);
        canvas.lineTo(right-20, top-alturaHeader-170-alturaDetalle-20);

        
        alturaDetalle = alturaDetalle + 85;
        Image img2 = Image.getInstance(RESOURCE2);
        img2.scaleAbsolute(130,50);
        img2.setAbsolutePosition((float)margen+25, (float)top-alturaHeader-170-alturaDetalle);
        document.add(img2);
        
        canvas.beginText();
        alturaDetalle = alturaDetalle + 20;
        canvas.showTextAligned(Element.ALIGN_CENTER, "Visualice este documento en", margen+60+30, top-alturaHeader-170-alturaDetalle, angulo);
        canvas.showTextAligned(Element.ALIGN_CENTER, boleta.getUrlDescarga(), margen+60+30, top-alturaHeader-170-alturaDetalle-15, angulo);
