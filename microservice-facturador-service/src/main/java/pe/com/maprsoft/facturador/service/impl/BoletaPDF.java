...
public class BoletaPDF {
    ...
    public static final String RESULT = "C:/boleta.pdf";
...
/*
        canvas.moveTo(margen+20, top-90-80-70-5);
        canvas.lineTo(right-20, top-90-80-70-5);
*/
        int angulo = 0;
        //PANER IZQUIERDO
        canvas.beginText();
        ...
        canvas.showTextAligned(Element.ALIGN_CENTER, "BOLETA ELECTRONICA N° "+ pago.getSerie()+'-'+pago.getNumero(), margen+50+40, top-alturaHeader-90, angulo);
